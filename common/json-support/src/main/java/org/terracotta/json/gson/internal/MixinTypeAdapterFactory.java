 ...
 * <p>
 * A mixin can override some fields from its superclass to define another adapter with {@link com.google.gson.annotations.JsonAdapter}
 */
public final class MixinTypeAdapterFactory implements TypeAdapterFactory {
  ...
  @SuppressWarnings("unchecked")
  private <T> TypeAdapter<T> getTypeAdapter(ConstructorConstructor constructorConstructor, Gson gson, TypeToken<T> type, JsonAdapter annotation) {
  ...
  /**
   * Copy of {@link com.google.gson.internal.bind.ReflectiveTypeAdapterFactory.FieldAdapter} for the {@link @org.terracotta.json.gson.internal.MixinTypeAdapterFactory}
   * <p>
  ...
  /**
   * Copy of {@link com.google.gson.internal.bind.ReflectiveTypeAdapterFactory.FieldReflectionAdapter} to use for the {@link @org.terracotta.json.gson.internal.MixinTypeAdapterFactory}
   */

 ...
 */
public class DisabledManagementAgentServerEntity extends ProxiedServerEntity<ManagementAgent> {
  public DisabledManagementAgentServerEntity() {
    super(ManagementAgent.class, new DisabledManagementAgent());
  }
}

...
public class ManagementAgentServerEntity extends ProxiedServerEntity<ManagementAgent> {
  ...
  public ManagementAgentServerEntity(ManagementAgentConfig config, IMonitoringProducer producer) {
    super(ManagementAgent.class, new ManagementAgentImpl(config, producer));
  }

 ...
 */
public class SampledRate extends AbstractMeasurableStatistic<List<Sample<Double>>, TimeUnit> {
  public SampledRate(String name, List<Sample<Double>> samples, TimeUnit timeUnit) {

...
----
include::{sourcedir}/src/test/java/org/terracotta/tampon/docs/GettingStarted.java[tag=createSimpleStructure]
----
...
[source,java,indent=0]
----
include::{sourcedir}/src/test/java/org/terracotta/tampon/docs/GettingStarted.java[tag=encodeSimpleStructure]
----
...
[source,java,indent=0]
----
include::{sourcedir}/src/test/java/org/terracotta/tampon/docs/GettingStarted.java[tag=decodeSimpleStructure]
----
<1> Create a `Struct` like explained above.

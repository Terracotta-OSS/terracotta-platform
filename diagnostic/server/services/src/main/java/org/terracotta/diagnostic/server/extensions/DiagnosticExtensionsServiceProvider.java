...
public class DiagnosticExtensionsServiceProvider implements ServiceProvider {
  ...
  public void addStateTo(StateDumpCollector stateDumpCollector) {
    ...
    StateDumpCollector kitInfoStateDumpCollector = stateDumpCollector.subStateDumpCollector("kitInformation");
    kitInfoStateDumpCollector.addState("version", extensionsMBean.getKitInformation().getVersion().toString());
    kitInfoStateDumpCollector.addState("revision", extensionsMBean.getKitInformation().getRevision());
    kitInfoStateDumpCollector.addState("branch", extensionsMBean.getKitInformation().getBranch());
    kitInfoStateDumpCollector.addState("timestamp", extensionsMBean.getKitInformation().getTimestamp().toString());
  }
}

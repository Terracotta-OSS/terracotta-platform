...
public class VoltronMonitoringServiceTest {
  ...
  public void test_notifs() {
    ...
    PlatformServer server1 = new PlatformServer();
    producer.addNode(SERVERS_PATH, "server1", server1);
    ...
    producer.addNode(new String[]{PLATFORM_ROOT_NAME, SERVERS_ROOT_NAME, "server1"}, "state", state);
    ...
    producer.addNode(ENTITIES_PATH, "entity1", entity1);
    notification = notifications.read();
    ...
    producer.addNode(CLIENTS_PATH, "client1", client1);
    notification = notifications.read();
    ...
    producer.addNode(FETCHED_PATH, "fetch1", fetch1);
    notification = notifications.read();

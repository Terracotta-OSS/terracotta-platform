 ...
 */
class PassiveNmsAgentServerEntity extends PassiveProxiedServerEntity<NmsAgent, Void, Void> {
  PassiveNmsAgentServerEntity(PassiveNmsAgent passiveNmsAgent) {
    super(passiveNmsAgent, null, null);
  }
}

...
import static org.terracotta.management.tms.entity.server.Utils.toClient;
      ...
      consumer.getChildNamesForNode(CLIENTS_PATH).ifPresent(connectionIdentifiers -> {
        for (String connectionIdentifier : connectionIdentifiers) {
          ...
          getPlatformConnectedClient(connectionIdentifier).ifPresent(connection -> {
            ...
            // find all management registry metadata exposed client-side through the "org.terracotta.management.entity.client.ManagementAgentEntity"

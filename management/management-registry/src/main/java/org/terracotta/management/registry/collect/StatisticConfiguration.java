...
public class StatisticConfiguration implements Serializable {
  ...
  public StatisticConfiguration setAverageWindowDuration(long averageWindowDuration, TimeUnit averageWindowUnit) {
    this.averageWindowDuration = averageWindowDuration;
    this.averageWindowUnit = averageWindowUnit;
    return this;
  }

  public StatisticConfiguration setHistoryInterval(long historyInterval, TimeUnit historyIntervalUnit) {
    this.historyInterval = historyInterval;
  ...
  public StatisticConfiguration setTimeToDisable(long timeToDisable, TimeUnit timeToDisableUnit) {
    this.timeToDisable = timeToDisable;

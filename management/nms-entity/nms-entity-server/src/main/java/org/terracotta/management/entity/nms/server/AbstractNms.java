 ...
 */
abstract class AbstractNms implements Nms, NmsMessenger {
  ...
  AbstractNms(ConsumerManagementRegistry consumerManagementRegistry, EntityMonitoringService entityMonitoringService, SharedManagementRegistry sharedManagementRegistry) {

...
public class DiagnosticRequestHandlerTest {
  ...
  public void test_add() {
    ...
    assertThat(
        () -> handler.add(MyService.class, new MyService() {}),
        is(throwing(instanceOf(IllegalArgumentException.class)).andMessage(is(equalTo("Service com.terracottatech.diagnostic.server.DiagnosticRequestHandlerTest$MyService is already registered")))));
  }

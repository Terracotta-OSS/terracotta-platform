...
import com.terracottatech.diagnostic.common.JavaDiagnosticCodec;
...
public class DiagnosticServiceImplTest {
  ...
  public void test_getProxy() {
    ...
    // test encoded request and OK success answer
    {
      ...
      assertThat(json, is(equalTo("{\"body\":{\"@class\":\"com.terracottatech.diagnostic.client.DiagnosticServiceImplTest$Beef\",\"quality\":\"AA\",\"raw\":false,\"time\":2}}")));

...
@PermanentEntity(type = "com.terracottatech.dynamic_config.service.management.DynamicConfigEntity", names = {"dynamic-config-management-entity"})
public class DynamicConfigEntityService implements EntityServerService<EntityMessage, EntityResponse> {

  private static final String ENTITY_TYPE = "com.terracottatech.dynamic_config.service.management.DynamicConfigEntity";

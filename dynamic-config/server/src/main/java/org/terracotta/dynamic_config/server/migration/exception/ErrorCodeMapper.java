...
import static org.terracotta.dynamic_config.server.migration.exception.ErrorCode.BOTH_WHITELIST_AND_DEPR_WHITELIST_PRESENT;
import static org.terracotta.dynamic_config.server.migration.exception.ErrorCode.MISMATCHED_CLIENT_LEASE_DURATION;
import static org.terracotta.dynamic_config.server.migration.exception.ErrorCode.MISMATCHED_DATA_DIRS;
import static org.terracotta.dynamic_config.server.migration.exception.ErrorCode.MISMATCHED_DATA_DIR_NUMBERS;
import static org.terracotta.dynamic_config.server.migration.exception.ErrorCode.MISMATCHED_OFFHEAP_RESOURCES;
import static org.terracotta.dynamic_config.server.migration.exception.ErrorCode.MISMATCHED_OFFHEAP_RESOURCE_NUMBERS;
import static org.terracotta.dynamic_config.server.migration.exception.ErrorCode.MISMATCHED_SECURITY_CONFIGURATION;
import static org.terracotta.dynamic_config.server.migration.exception.ErrorCode.MULTIPLE_PLATFORM_DATA_DIRS;
import static org.terracotta.dynamic_config.server.migration.exception.ErrorCode.NON_UNIQUE_PLATFORM_DATA_DIR_NAME;
import static org.terracotta.dynamic_config.server.migration.exception.ErrorCode.PLATFORM_DATA_DIR_MISSING_IN_SOME_CONFIG_FILES;
import static org.terracotta.dynamic_config.server.migration.exception.ErrorCode.UNKNOWN_ERROR;

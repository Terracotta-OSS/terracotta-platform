...
public class SecurityLogDirChangeHandler implements ConfigChangeHandler {
  private final IParameterSubstitutor parameterSubstitutor;
  private final PathResolver pathResolver;

  public SecurityLogDirChangeHandler(IParameterSubstitutor parameterSubstitutor, PathResolver pathResolver) {
  ...
  public void validate(NodeContext nodeContext, Configuration change) throws InvalidConfigChangeException {
    ...
    if (logPath == null) {
      ...
      RawPath rawPath = Setting.SECURITY_LOG_DIR.getDefaultValue();

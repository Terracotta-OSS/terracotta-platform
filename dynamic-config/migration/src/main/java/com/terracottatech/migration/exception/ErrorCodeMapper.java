...
import static com.terracottatech.migration.exception.ErrorCode.BOTH_WHITELIST_AND_DEPR_WHITELIST_PRESENT;
import static com.terracottatech.migration.exception.ErrorCode.MISMATCHED_DATA_DIRS;
import static com.terracottatech.migration.exception.ErrorCode.MISMATCHED_DATA_DIR_NUMBERS;
import static com.terracottatech.migration.exception.ErrorCode.MISMATCHED_CLIENT_LEASE_DURATION;
import static com.terracottatech.migration.exception.ErrorCode.MISMATCHED_OFFHEAP_RESOURCES;
import static com.terracottatech.migration.exception.ErrorCode.MISMATCHED_OFFHEAP_RESOURCE_NUMBERS;
...
import static com.terracottatech.migration.exception.ErrorCode.NON_UNIQUE_PLATFORM_DATA_DIR_NAME;
import static com.terracottatech.migration.exception.ErrorCode.PLATFORM_DATA_DIR_MISSING_IN_SOME_CONFIG_FILES;

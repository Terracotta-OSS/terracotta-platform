...
public class ErrorCodeMapper {
  ...
  static {
    ...
    ERROR_MAP.put(800001L, new ErrorDetail(MISMATCHED_DATA_DIR_RESOURCE_NUMBERS
        , "Number of data directories defined in %s and in %s are not matching"));
    ERROR_MAP.put(800002L, new ErrorDetail(PLATFORM_DATA_ROOT_MISSING_IN_SOME_OF_THE_CONFIG_FILES
        , "Platform data root missing in one of %s %s"));
    ERROR_MAP.put(800003L, new ErrorDetail(MISMATCHED_DATA_DIR
        , "Data root directories are not same in %s and %s"));
    ERROR_MAP.put(800004L, new ErrorDetail(NON_UNIQUE_PLATFORM_DATA_ROOT_NAME
    ...
    ERROR_MAP.put(900001L, new ErrorDetail(BOTH_WHITELIST_DEPR_WHITELIST_PRESENT
    ...
    //Lease
    ERROR_MAP.put(700001L, new ErrorDetail(MISMATCHED_LEASE_TIME_CONFIGURATION
        , "Mismatched lease configuration in %s"));

    //OffHeap
    ERROR_MAP.put(500001L, new ErrorDetail(MISMATCHED_OFF_HEAP_RESOURCE_NUMBERS
        , "Different number of off-heap resources are defined in %s and %s"));
    ERROR_MAP.put(500002L, new ErrorDetail(MISMATCHED_OFF_HEAPS

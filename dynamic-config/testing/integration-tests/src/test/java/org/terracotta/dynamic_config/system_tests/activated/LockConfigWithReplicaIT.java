...
public class LockConfigWithReplicaIT extends DynamicConfigIT {
  private final LockContext lockContext = new LockContext(UUID.randomUUID().toString(), "platform", "dynamic-scale");
  @Test
  public void testLockUnlockWithReplicaNodes() throws Exception {
    startNode(1, 1);

...
public class DetachStripeWithReplicaIT extends DynamicConfigIT {
  @Test
  public void test_detach_stripe_from_activated_cluster_with_replica() throws Exception {
    ...
    waitUntil(() -> configTool("log", "-s", "localhost:" + getNodePort(1, 1)), allOf(is(successful()), containsOutput("Detaching stripe:")));
  }
}

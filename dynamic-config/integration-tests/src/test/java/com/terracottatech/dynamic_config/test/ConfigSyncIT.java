...
import static com.terracottatech.dynamic_config.nomad.persistence.NomadSanskritKeys.*;
...
public class ConfigSyncIT extends BaseStartupIT {
  ...
  private void assertContentsAfterSync(List<SanskritObject> activeChanges, List<SanskritObject> passiveChanges) {
  ...
  private void assertContentsBeforeSync(List<SanskritObject> activeChanges, List<SanskritObject> passiveChanges) {
    assertThat(activeChanges.size(), is(5));

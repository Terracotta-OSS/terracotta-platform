...
import com.terracottatech.dynamic_config.cli.service.command.MigrateCommand;
...
public class MigrationTool {
  ...
  public static void start(String... args) {
    ...
    // create services
    DiagnosticServiceProvider diagnosticServiceProvider = new DiagnosticServiceProvider("MIGRATION-TOOL", connectionTimeout, requestTimeout, MAIN.getSecurityRootDirectory());

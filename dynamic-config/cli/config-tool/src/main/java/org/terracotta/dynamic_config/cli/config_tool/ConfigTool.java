...
public class ConfigTool {
  ...
  public static void start(String... args) {
    CommandMapper mapper = ManagedServiceLoader.loadServices(CommandMapper.class, ConfigTool.class.getClassLoader())
    ...
    List<Command> commands = mapper.getCommands();
    commands.add(mainCommand);
    commandRepository.addAll(new HashSet<>(commands));

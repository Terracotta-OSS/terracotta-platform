 ...
 */
public abstract class TopologyActionTest<C extends TopologyAction> extends BaseTest {
  ...
  protected final C newCommand() {
    return inject(newTopologyCommand(), asList(diagnosticServiceProvider, multiDiagnosticServiceProvider, nomadManager, restartService, stopService, jsonFactory, nomadEntityProvider, outputService, json));
  }

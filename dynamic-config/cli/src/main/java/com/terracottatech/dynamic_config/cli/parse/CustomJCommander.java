 ...
 */
package com.terracottatech.dynamic_config.cli.parse;
...
public class CustomJCommander extends JCommander {
  ...
  public CustomJCommander(DynamicConfigCommand command, CommandManager commandManager) {
    super(command);
  ...
  private void appendUsage(DynamicConfigCommand command, StringBuilder out, String indent) {

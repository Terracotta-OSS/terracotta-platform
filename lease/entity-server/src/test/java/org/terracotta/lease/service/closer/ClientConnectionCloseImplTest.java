...
public class ClientConnectionCloseImplTest {
  @Test
  public void delegatesToClientCommunicator() {
    ...
    ClientConnectionCloserImpl closer = new ClientConnectionCloserImpl(clientCommunicator);
    closer.closeClientConnection(clientDescriptor);

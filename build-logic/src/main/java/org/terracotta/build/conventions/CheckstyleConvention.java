 ...
 * </ul>
 */
public class CheckstyleConvention implements ConventionPlugin<Project, CheckstylePlugin> {

  @Override
  public Class<CheckstylePlugin> isConventionFor() {
    return CheckstylePlugin.class;
  }
